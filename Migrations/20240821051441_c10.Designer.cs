            ...
            modelBuilder.Entity("IsDB_R57_Solely.Entities.Products.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ProductId = 1,
                            BrandId = 1,
                            CreatedOn = new DateTime(2024, 8, 21, 11, 14, 40, 559, DateTimeKind.Local).AddTicks(6487),
                        ...
                        new
                        {
                            ProductId = 2,
                            BrandId = 2,
                            CreatedOn = new DateTime(2024, 8, 21, 11, 14, 40, 559, DateTimeKind.Local).AddTicks(6490),
                        ...
                        new
                        {
                            ProductId = 3,
                            BrandId = 3,
                            CreatedOn = new DateTime(2024, 8, 21, 11, 14, 40, 559, DateTimeKind.Local).AddTicks(6492),
                        ...
                        new
                        {
                            ProductId = 4,
                            BrandId = 4,
                            CreatedOn = new DateTime(2024, 8, 21, 11, 14, 40, 559, DateTimeKind.Local).AddTicks(6495),
                        ...
                        new
                        {
                            ProductId = 5,
                            BrandId = 5,
                            CreatedOn = new DateTime(2024, 8, 21, 11, 14, 40, 559, DateTimeKind.Local).AddTicks(6498),
            ...
            modelBuilder.Entity("IsDB_R57_Solely.Entities.Users.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "f9201efa-8fb9-4525-a4b5-77819b0b3b23",
                            CreatedOn = new DateTime(2024, 8, 21, 5, 14, 40, 559, DateTimeKind.Utc).AddTicks(6593),
                        ...
                        new
                        {
                            Id = 2,
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "4ddb7724-771c-4605-9f2c-8e640b9a7d8b",
                            CreatedOn = new DateTime(2024, 8, 21, 5, 14, 40, 559, DateTimeKind.Utc).AddTicks(6651),
                            EmailConfirmed = false,
                            FirstName = "Jane",
                            LastName = "Smith",
                            LockoutEnabled = false,
            ...
            modelBuilder.Entity("IsDB_R57_Solely.Entities.Products.Product", b =>
                {
                    ...
                    b.HasOne("IsDB_R57_Solely.Entities.Products.Brand", null)
                        .WithMany("Products")
                    ...
                    b.HasOne("IsDB_R57_Solely.Entities.Products.Category", null)
                        .WithMany("Products")
