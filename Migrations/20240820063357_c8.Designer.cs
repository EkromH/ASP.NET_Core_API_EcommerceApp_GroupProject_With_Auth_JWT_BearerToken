            ...
            modelBuilder.Entity("IsDB_R57_Solely.Entities.Products.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ProductId = 1,
                            BrandId = 1,
                            CreatedOn = new DateTime(2024, 8, 20, 12, 33, 56, 187, DateTimeKind.Local).AddTicks(4826),
                        ...
                        new
                        {
                            ProductId = 2,
                            BrandId = 2,
                            CreatedOn = new DateTime(2024, 8, 20, 12, 33, 56, 187, DateTimeKind.Local).AddTicks(4829),
                        ...
                        new
                        {
                            ProductId = 3,
                            BrandId = 3,
                            CreatedOn = new DateTime(2024, 8, 20, 12, 33, 56, 187, DateTimeKind.Local).AddTicks(4832),
                        ...
                        new
                        {
                            ProductId = 4,
                            BrandId = 4,
                            CreatedOn = new DateTime(2024, 8, 20, 12, 33, 56, 187, DateTimeKind.Local).AddTicks(4834),
                        ...
                        new
                        {
                            ProductId = 5,
                            BrandId = 5,
                            CreatedOn = new DateTime(2024, 8, 20, 12, 33, 56, 187, DateTimeKind.Local).AddTicks(4837),
            ...
            modelBuilder.Entity("IsDB_R57_Solely.Entities.Users.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "86409177-800c-43cd-8620-31a032bb09e0",
                            CreatedOn = new DateTime(2024, 8, 20, 6, 33, 56, 187, DateTimeKind.Utc).AddTicks(4930),
                        ...
                        new
                        {
                            Id = 2,
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "ed48d0e3-21de-42e9-b959-3fc46b8111b0",
                            CreatedOn = new DateTime(2024, 8, 20, 6, 33, 56, 187, DateTimeKind.Utc).AddTicks(4973),
                            EmailConfirmed = false,
                            FirstName = "Jane",
                            LastName = "Smith",
                            LockoutEnabled = false,
