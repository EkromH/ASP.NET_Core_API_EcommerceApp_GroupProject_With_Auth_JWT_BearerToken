...
namespace IsDB_R57_Solely.Migrations
{
    ...
    [Migration("20240814032525_changedMigration")]
            ...
            modelBuilder.Entity("IsDB_R57_Solely.Entities.Products.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ProductId = 1,
                            BrandId = 1,
                            CreatedOn = new DateTime(2024, 8, 14, 9, 25, 24, 359, DateTimeKind.Local).AddTicks(6453),
                        ...
                        new
                        {
                            ProductId = 2,
                            BrandId = 2,
                            CreatedOn = new DateTime(2024, 8, 14, 9, 25, 24, 359, DateTimeKind.Local).AddTicks(6457),
                        ...
                        new
                        {
                            ProductId = 3,
                            BrandId = 3,
                            CreatedOn = new DateTime(2024, 8, 14, 9, 25, 24, 359, DateTimeKind.Local).AddTicks(6459),
                        ...
                        new
                        {
                            ProductId = 4,
                            BrandId = 4,
                            CreatedOn = new DateTime(2024, 8, 14, 9, 25, 24, 359, DateTimeKind.Local).AddTicks(6462),
                        ...
                        new
                        {
                            ProductId = 5,
                            BrandId = 5,
                            CreatedOn = new DateTime(2024, 8, 14, 9, 25, 24, 359, DateTimeKind.Local).AddTicks(6464),
            ...
            modelBuilder.Entity("IsDB_R57_Solely.Entities.Users.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "b53c0ccc-b4c5-4cdc-bbff-b30e5f7071ee",
                            CreatedOn = new DateTime(2024, 8, 14, 3, 25, 24, 359, DateTimeKind.Utc).AddTicks(6548),
                        ...
                        new
                        {
                            Id = 2,
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "9fd1d4be-d9cd-44c8-a369-b1ef96214a4b",
                            CreatedOn = new DateTime(2024, 8, 14, 3, 25, 24, 359, DateTimeKind.Utc).AddTicks(6551),
                            EmailConfirmed = false,
                            FirstName = "Jane",
                            LastName = "Smith",
                            LockoutEnabled = false,
