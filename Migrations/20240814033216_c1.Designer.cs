            ...
            modelBuilder.Entity("IsDB_R57_Solely.Entities.Products.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ProductId = 1,
                            BrandId = 1,
                            CreatedOn = new DateTime(2024, 8, 14, 9, 32, 15, 215, DateTimeKind.Local).AddTicks(8494),
                        ...
                        new
                        {
                            ProductId = 2,
                            BrandId = 2,
                            CreatedOn = new DateTime(2024, 8, 14, 9, 32, 15, 215, DateTimeKind.Local).AddTicks(8497),
                        ...
                        new
                        {
                            ProductId = 3,
                            BrandId = 3,
                            CreatedOn = new DateTime(2024, 8, 14, 9, 32, 15, 215, DateTimeKind.Local).AddTicks(8499),
                        ...
                        new
                        {
                            ProductId = 4,
                            BrandId = 4,
                            CreatedOn = new DateTime(2024, 8, 14, 9, 32, 15, 215, DateTimeKind.Local).AddTicks(8501),
                        ...
                        new
                        {
                            ProductId = 5,
                            BrandId = 5,
                            CreatedOn = new DateTime(2024, 8, 14, 9, 32, 15, 215, DateTimeKind.Local).AddTicks(8505),
            ...
            modelBuilder.Entity("IsDB_R57_Solely.Entities.Users.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "de1e4bfc-b551-4962-ba69-36ad6db6baee",
                            CreatedOn = new DateTime(2024, 8, 14, 3, 32, 15, 215, DateTimeKind.Utc).AddTicks(8597),
                        ...
                        new
                        {
                            Id = 2,
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "8b055022-af12-47e2-b883-74bbda9b521d",
                            CreatedOn = new DateTime(2024, 8, 14, 3, 32, 15, 215, DateTimeKind.Utc).AddTicks(8602),
                            EmailConfirmed = false,
                            FirstName = "Jane",
                            LastName = "Smith",
                            LockoutEnabled = false,
