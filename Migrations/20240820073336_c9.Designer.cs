            ...
            modelBuilder.Entity("IsDB_R57_Solely.Entities.Products.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ProductId = 1,
                            BrandId = 1,
                            CreatedOn = new DateTime(2024, 8, 20, 13, 33, 34, 867, DateTimeKind.Local).AddTicks(8029),
                        ...
                        new
                        {
                            ProductId = 2,
                            BrandId = 2,
                            CreatedOn = new DateTime(2024, 8, 20, 13, 33, 34, 867, DateTimeKind.Local).AddTicks(8032),
                        ...
                        new
                        {
                            ProductId = 3,
                            BrandId = 3,
                            CreatedOn = new DateTime(2024, 8, 20, 13, 33, 34, 867, DateTimeKind.Local).AddTicks(8035),
                        ...
                        new
                        {
                            ProductId = 4,
                            BrandId = 4,
                            CreatedOn = new DateTime(2024, 8, 20, 13, 33, 34, 867, DateTimeKind.Local).AddTicks(8039),
                        ...
                        new
                        {
                            ProductId = 5,
                            BrandId = 5,
                            CreatedOn = new DateTime(2024, 8, 20, 13, 33, 34, 867, DateTimeKind.Local).AddTicks(8041),
            ...
            modelBuilder.Entity("IsDB_R57_Solely.Entities.Users.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "c0307b40-9bf7-4783-a359-88e15d5d3e1d",
                            CreatedOn = new DateTime(2024, 8, 20, 7, 33, 34, 867, DateTimeKind.Utc).AddTicks(8141),
                        ...
                        new
                        {
                            Id = 2,
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "5012c06b-011f-4f11-82f0-02e7dff88b39",
                            CreatedOn = new DateTime(2024, 8, 20, 7, 33, 34, 867, DateTimeKind.Utc).AddTicks(8156),
                            EmailConfirmed = false,
                            FirstName = "Jane",
                            LastName = "Smith",
                            LockoutEnabled = false,
