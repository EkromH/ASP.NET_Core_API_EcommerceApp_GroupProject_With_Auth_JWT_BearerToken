...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("IsDB_R57_Solely.Entities.Products.Product", b =>
                {
                    ...
                    b.Property<int?>("ProductAttributeId1")
                        .HasColumnType("int");
                    ...
                    b.HasData(
                        new
                        {
                            ProductId = 1,
                            BrandId = 1,
                            CreatedOn = new DateTime(2024, 8, 20, 10, 30, 55, 534, DateTimeKind.Local).AddTicks(8050),
                        ...
                        new
                        {
                            ProductId = 2,
                            BrandId = 2,
                            CreatedOn = new DateTime(2024, 8, 20, 10, 30, 55, 534, DateTimeKind.Local).AddTicks(8052),
                        ...
                        new
                        {
                            ProductId = 3,
                            BrandId = 3,
                            CreatedOn = new DateTime(2024, 8, 20, 10, 30, 55, 534, DateTimeKind.Local).AddTicks(8055),
                        ...
                        new
                        {
                            ProductId = 4,
                            BrandId = 4,
                            CreatedOn = new DateTime(2024, 8, 20, 10, 30, 55, 534, DateTimeKind.Local).AddTicks(8057),
                        ...
                        new
                        {
                            ProductId = 5,
                            BrandId = 5,
                            CreatedOn = new DateTime(2024, 8, 20, 10, 30, 55, 534, DateTimeKind.Local).AddTicks(8060),
            ...
            modelBuilder.Entity("IsDB_R57_Solely.Entities.Products.ProductAttribute", b =>
                {
                    b.Property<int>("ProductAttributeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("IsDB_R57_Solely.Entities.Users.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "b10fc82d-587e-4797-a436-6afa27b9dc86",
                            CreatedOn = new DateTime(2024, 8, 20, 4, 30, 55, 534, DateTimeKind.Utc).AddTicks(8160),
                        ...
                        new
                        {
                            Id = 2,
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "1e16e765-1b6f-4b02-b9ba-66a28fc7cfdd",
                            CreatedOn = new DateTime(2024, 8, 20, 4, 30, 55, 534, DateTimeKind.Utc).AddTicks(8163),
                            EmailConfirmed = false,
                            FirstName = "Jane",
                            LastName = "Smith",
                            LockoutEnabled = false,
            ...
            modelBuilder.Entity("IsDB_R57_Solely.Entities.Inventory.Stock", b =>
                {
                    b.HasOne("IsDB_R57_Solely.Entities.Products.Product", "Product")
                        .WithOne("Stock")
                        .HasForeignKey("IsDB_R57_Solely.Entities.Inventory.Stock", "ProductId");
            ...
            modelBuilder.Entity("IsDB_R57_Solely.Entities.Orders.OrderItem", b =>
                {
                    ...
                    b.OwnsOne("IsDB_R57_Solely.DAL.ViewModel.ProductOrdered", "Item", b1 =>
                        {
                            ...
                            b1.Property<string>("ThumbnailImage")
                                .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("IsDB_R57_Solely.Entities.Products.Product", b =>
                {
                    ...
                    b.HasOne("IsDB_R57_Solely.Entities.Products.ProductAttribute", "ProductAttribute")
                        .WithMany()
                        .HasForeignKey("ProductAttributeId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("IsDB_R57_Solely.Entities.Products.ProductAttribute", null)
                        .WithMany("Products")
                    ...
                    b.HasOne("IsDB_R57_Solely.Entities.Products.Tag", null)
                        .WithMany("Products")
