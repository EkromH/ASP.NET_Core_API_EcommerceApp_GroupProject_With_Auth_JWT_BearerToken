            ...
            modelBuilder.Entity("IsDB_R57_Solely.Entities.Products.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ProductId = 1,
                            BrandId = 1,
                            CreatedOn = new DateTime(2024, 8, 15, 10, 48, 50, 976, DateTimeKind.Local).AddTicks(5668),
                        ...
                        new
                        {
                            ProductId = 2,
                            BrandId = 2,
                            CreatedOn = new DateTime(2024, 8, 15, 10, 48, 50, 976, DateTimeKind.Local).AddTicks(5671),
                        ...
                        new
                        {
                            ProductId = 3,
                            BrandId = 3,
                            CreatedOn = new DateTime(2024, 8, 15, 10, 48, 50, 976, DateTimeKind.Local).AddTicks(5673),
                        ...
                        new
                        {
                            ProductId = 4,
                            BrandId = 4,
                            CreatedOn = new DateTime(2024, 8, 15, 10, 48, 50, 976, DateTimeKind.Local).AddTicks(5676),
                        ...
                        new
                        {
                            ProductId = 5,
                            BrandId = 5,
                            CreatedOn = new DateTime(2024, 8, 15, 10, 48, 50, 976, DateTimeKind.Local).AddTicks(5678),
            ...
            modelBuilder.Entity("IsDB_R57_Solely.Entities.Users.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "484f1051-348a-4e4b-83f5-070c272ebf53",
                            CreatedOn = new DateTime(2024, 8, 15, 4, 48, 50, 976, DateTimeKind.Utc).AddTicks(5780),
                        ...
                        new
                        {
                            Id = 2,
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "25f16878-b2c6-4d23-8b46-7f35bf622721",
                            CreatedOn = new DateTime(2024, 8, 15, 4, 48, 50, 976, DateTimeKind.Utc).AddTicks(5783),
                            EmailConfirmed = false,
                            FirstName = "Jane",
                            LastName = "Smith",
                            LockoutEnabled = false,
