            ...
            modelBuilder.Entity("IsDB_R57_Solely.Entities.Products.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ProductId = 1,
                            BrandId = 1,
                            CreatedOn = new DateTime(2024, 8, 19, 13, 12, 17, 126, DateTimeKind.Local).AddTicks(4608),
                        ...
                        new
                        {
                            ProductId = 2,
                            BrandId = 2,
                            CreatedOn = new DateTime(2024, 8, 19, 13, 12, 17, 126, DateTimeKind.Local).AddTicks(4611),
                        ...
                        new
                        {
                            ProductId = 3,
                            BrandId = 3,
                            CreatedOn = new DateTime(2024, 8, 19, 13, 12, 17, 126, DateTimeKind.Local).AddTicks(4613),
                        ...
                        new
                        {
                            ProductId = 4,
                            BrandId = 4,
                            CreatedOn = new DateTime(2024, 8, 19, 13, 12, 17, 126, DateTimeKind.Local).AddTicks(4616),
                        ...
                        new
                        {
                            ProductId = 5,
                            BrandId = 5,
                            CreatedOn = new DateTime(2024, 8, 19, 13, 12, 17, 126, DateTimeKind.Local).AddTicks(4618),
            ...
            modelBuilder.Entity("IsDB_R57_Solely.Entities.Users.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "63bddeef-d424-49cc-9ed8-ae37823de7c3",
                            CreatedOn = new DateTime(2024, 8, 19, 7, 12, 17, 126, DateTimeKind.Utc).AddTicks(4702),
                        ...
                        new
                        {
                            Id = 2,
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "99e68aec-1acb-4380-a2bd-50d3160f5af2",
                            CreatedOn = new DateTime(2024, 8, 19, 7, 12, 17, 126, DateTimeKind.Utc).AddTicks(4705),
                            EmailConfirmed = false,
                            FirstName = "Jane",
                            LastName = "Smith",
                            LockoutEnabled = false,
