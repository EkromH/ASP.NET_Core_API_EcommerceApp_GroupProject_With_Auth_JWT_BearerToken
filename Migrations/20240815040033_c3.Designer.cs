            ...
            modelBuilder.Entity("IsDB_R57_Solely.Entities.Products.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ProductId = 1,
                            BrandId = 1,
                            CreatedOn = new DateTime(2024, 8, 15, 10, 0, 31, 836, DateTimeKind.Local).AddTicks(1257),
                        ...
                        new
                        {
                            ProductId = 2,
                            BrandId = 2,
                            CreatedOn = new DateTime(2024, 8, 15, 10, 0, 31, 836, DateTimeKind.Local).AddTicks(1260),
                        ...
                        new
                        {
                            ProductId = 3,
                            BrandId = 3,
                            CreatedOn = new DateTime(2024, 8, 15, 10, 0, 31, 836, DateTimeKind.Local).AddTicks(1262),
                        ...
                        new
                        {
                            ProductId = 4,
                            BrandId = 4,
                            CreatedOn = new DateTime(2024, 8, 15, 10, 0, 31, 836, DateTimeKind.Local).AddTicks(1264),
                        ...
                        new
                        {
                            ProductId = 5,
                            BrandId = 5,
                            CreatedOn = new DateTime(2024, 8, 15, 10, 0, 31, 836, DateTimeKind.Local).AddTicks(1266),
            ...
            modelBuilder.Entity("IsDB_R57_Solely.Entities.Users.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "4ef02c8c-5a44-4631-bc9f-a71c1b1e3487",
                            CreatedOn = new DateTime(2024, 8, 15, 4, 0, 31, 836, DateTimeKind.Utc).AddTicks(1346),
                        ...
                        new
                        {
                            Id = 2,
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "c956fd58-bb1b-4f77-a0c8-9158c64fb3b4",
                            CreatedOn = new DateTime(2024, 8, 15, 4, 0, 31, 836, DateTimeKind.Utc).AddTicks(1349),
                            EmailConfirmed = false,
                            FirstName = "Jane",
                            LastName = "Smith",
                            LockoutEnabled = false,
