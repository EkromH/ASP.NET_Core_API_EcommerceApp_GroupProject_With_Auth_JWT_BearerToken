            ...
            modelBuilder.Entity("IsDB_R57_Solely.Entities.Products.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ProductId = 1,
                            BrandId = 1,
                            CreatedOn = new DateTime(2024, 8, 15, 1, 49, 12, 404, DateTimeKind.Local).AddTicks(5778),
                        ...
                        new
                        {
                            ProductId = 2,
                            BrandId = 2,
                            CreatedOn = new DateTime(2024, 8, 15, 1, 49, 12, 404, DateTimeKind.Local).AddTicks(5783),
                        ...
                        new
                        {
                            ProductId = 3,
                            BrandId = 3,
                            CreatedOn = new DateTime(2024, 8, 15, 1, 49, 12, 404, DateTimeKind.Local).AddTicks(5787),
                        ...
                        new
                        {
                            ProductId = 4,
                            BrandId = 4,
                            CreatedOn = new DateTime(2024, 8, 15, 1, 49, 12, 404, DateTimeKind.Local).AddTicks(5791),
                        ...
                        new
                        {
                            ProductId = 5,
                            BrandId = 5,
                            CreatedOn = new DateTime(2024, 8, 15, 1, 49, 12, 404, DateTimeKind.Local).AddTicks(5794),
            ...
            modelBuilder.Entity("IsDB_R57_Solely.Entities.Users.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "0c02393d-e36a-43da-a34f-fb175ea76e1a",
                            CreatedOn = new DateTime(2024, 8, 14, 19, 49, 12, 404, DateTimeKind.Utc).AddTicks(5904),
                        ...
                        new
                        {
                            Id = 2,
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "63983bf5-e83a-4ca9-9114-e2bee4787c75",
                            CreatedOn = new DateTime(2024, 8, 14, 19, 49, 12, 404, DateTimeKind.Utc).AddTicks(5909),
                            EmailConfirmed = false,
                            FirstName = "Jane",
                            LastName = "Smith",
                            LockoutEnabled = false,
